...
class CharactersListViewController: UIViewController {
    ...
    private lazy var statusesCollectionView: UICollectionView = {
...
extension CharactersListViewController {
    ...
    private func addStatusesCollectionView() {
        self.statusesCollectionView.showsVerticalScrollIndicator = false
        self.statusesCollectionView.showsHorizontalScrollIndicator = false
        self.statusesCollectionView.contentInsetAdjustmentBehavior = .never
        self.statusesCollectionView.allowsMultipleSelection = false
        self.statusesCollectionView.delegate = self
        self.statusesCollectionView.dataSource = self
        self.statusesCollectionView.contentInset.left = 16
        
        self.statusesCollectionView.register(StatusCollectionViewCell.self)
        self.view.addSubview(self.statusesCollectionView)
    }
    
    private func addStatusesCollectionViewConstraints() {
        self.statusesCollectionView.snp.makeConstraints {
...
extension CharactersListViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.setup(with: self.viewModel.getStatus(by: indexPath.item) ?? "")
        return cell
    }
}
